...
Public Class BoyerMooreTemplateMatching
	...
	Public Function ProcessImage(ByVal image As AForge.Imaging.UnmanagedImage, ByVal template As AForge.Imaging.UnmanagedImage, ByVal searchZone As System.Drawing.Rectangle) As Rectangle()
		Return Nothing
	End Function
